      ...
      <section className="pb-20 px-4 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {destinations.map((dest) => (
            <div key={dest.id} className="group flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 transition-all hover:shadow-md">
              ...
              <div className="p-6">
                <h3 className="text-xl font-serif font-bold mb-3">{dest.country}</h3>
